...
const contactTranslations = {
  ru: {
    ...
    contactInfoItems: [
      ...
      { title: "Телефон", value: "+7 (708) 021-18-48", href: "tel:+77080211848" },
  ...
  en: {
    ...
    contactInfoItems: [
      ...
      { title: "Email", value: "info@sengroup.one", href: "mailto:info@sengroup.one" },
      { title: "Phone", value: "+7 (708) 021-18-48", href: "tel:+77080211848" },
            ...
            <div className="glass rounded-3xl p-8">
              ...
              <div className="flex flex-wrap gap-3">
                {[
                  ...
                  { name: "WhatsApp", href: "https://wa.me/77080211848", icon: (
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
